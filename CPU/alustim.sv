...
module alustim();
	...
	initial begin
		...
		for (i=0; i<64; i++) begin
			A <<= 1;
			#(delay);
			assert((result == A + B) && zero == (B == '0) && negative == result[63]);
		end
		A = 64'h0000000000000001; B = 64'hFFFFFFFFFFFFFFFE;
		#(delay);
		...
		A = 64'h0000000000000001; B = 64'h0000000000000001;
		#(delay);
		assert(result == 64'h0000000000000000 && carry_out == 1 && overflow == 1 && negative == 0 && zero == 1);//carryO
		A = 64'h0000000000000001; B = 64'hFFFFFFFFFFFFFFFE;
		#(delay);
		...
		A = 64'h0000000000000001; B = 64'h0000000000000001;
		#(delay);
		assert(result == 64'h0000000000000001 && zero == 0 && negative == 0);
		...
		A = 64'h0000000000000001; B = 64'h0000000000000001;
		#(delay);
		assert(result == 64'h0000000000000000 && zero == 1 && negative == 0); //too slow to update value?
		A = 64'h0000000000000001; B = 64'hFFFFFFFFFFFFFFFE;
		#(delay);
		assert(result == 64'hFFFFFFFFFFFFFFFF && zero == 0 && negative == 1);
		A = 64'hF0F0F0F0F0F0F0F0; B = 64'h0F0F0F0F0F0F0F0F;
		#(delay);
		assert(result == 64'hFFFFFFFFFFFFFFFF && zero == 0 && negative == 1);
		A = 64'h0F0F0F0F0F0F0F0F; B = 64'h0F0F0F0F0F0F0F0F;
		#(delay);
		assert(result == 64'h0000000000000000 && zero == 1 && negative == 0);
		#(delay);
